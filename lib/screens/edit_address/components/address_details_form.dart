...
class _AddressDetailsFormState extends State<AddressDetailsForm> {
  ...
  Widget buildTitleField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: "Immettere un titolo per l'indirizzo",
        labelText: "Titolo",
  ...
  Widget buildReceiverField() {
    return TextFormField(
      ...
      keyboardType: TextInputType.name,
      decoration: InputDecoration(
        hintText: "Immettere il nome completo del destinatario",
        labelText: "Nome del destinatario",
        floatingLabelBehavior: FloatingLabelBehavior.always,
      ),
      validator: (value) {
  ...
  Widget buildAddressLine1Field() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: "Immettere la riga dell'indirizzo No. 1",
        labelText: "Riga indirizzo 1",
        floatingLabelBehavior: FloatingLabelBehavior.always,
      ),
      validator: (value) {
  ...
  Widget buildAddressLine2Field() {
    return TextFormField(
      ...
      keyboardType: TextInputType.streetAddress,
      decoration: InputDecoration(
        hintText: "Immettere la riga dell'indirizzo No. 2",
        labelText: "Riga indirizzo 2",
        floatingLabelBehavior: FloatingLabelBehavior.always,
      ),
      validator: (value) {
  ...
  Widget buildPincodeField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: "Immettere il codice PIN",
        labelText: "Codice PIN",
        floatingLabelBehavior: FloatingLabelBehavior.always,
      ),
      validator: (value) {
        if (pincodeFieldController.text.isEmpty) {
          ...
          return "Campo solo cifre";
        } else if (pincodeFieldController.text.length != 6) {
          return "Il CODICE PIN deve essere composto solo da 6 cifre";
        }
        return null;
      },
      autovalidateMode: AutovalidateMode.onUserInteraction,
  ...
  Future<void> saveNewAddressButtonCallback() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (status == true) {
          snackbarMessage = "Indirizzo salvato con successo";
        } else {
          throw "Impossibile salvare l'indirizzo per motivi sconosciuti";
        }
  ...
  Future<void> saveEditedAddressButtonCallback() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (status == true) {
          snackbarMessage = "Indirizzo Aggiornato con Successo";
        } else {
          throw "Impossibile aggiornare l'indirizzo per motivi sconosciuti";
        }
      } on FirebaseException catch (e) {
        Logger().w("Firebase Exception: $e");
        snackbarMessage = "Qualcosa è andato storto";
