...
import 'package:wonderjoys/components/rounded_icon_button.dart';
import 'package:wonderjoys/components/search_field.dart';
...
import 'package:wonderjoys/services/data_streams/category_products_stream.dart';
                          ...
                          if (productsId.length == 0) {
                            return Center(
                              child: NothingToShowContainer(
                                secondaryMessage:
                                    "Nessun prodotto in ${EnumToString.convertToString(widget.productType)}",
                              ),
                            );
                          }
