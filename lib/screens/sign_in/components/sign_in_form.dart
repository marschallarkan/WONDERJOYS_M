...
import 'package:wonderjoys/screens/forgot_password/forgot_password_screen.dart';
        ...
        signInStatus = await showDialog(
          ...
          builder: (context) {
            return FutureProgressDialog(
              signInFuture,
              message: Text("Accesso all'account"),
            );
          },
        );
        if (signInStatus == true) {
          snackbarMessage = "Accesso Eseguito con Successo";
        } else {
