...
import 'package:wonderjoys/models/Review.dart';
import 'package:wonderjoys/screens/my_orders/components/product_review_dialog.dart';
...
import 'package:wonderjoys/services/data_streams/ordered_products_stream.dart';
          ...
          if (orderedProductsIds.length == 0) {
            return Center(
              child: NothingToShowContainer(
                ...
                secondaryMessage: "Ordina qualcosa da mostrare qui",
              ),
            );
          }
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () async {
                      ...
                      if (result is Review) {
                        ...
                        try {
                          ...
                          if (reviewAdded == true) {
                            snackbarMessage =
                                "Recensione del prodotto aggiunta con successo";
                          } else {
                            throw "Impossibile aggiungere la recensione del prodotto per motivi sconosciuti";
                          }
                        } on FirebaseException catch (e) {
                          Logger().w("Firebase Exception: $e");
                    ...
                    child: Text(
                      "Dai una Recensione al Prodotto",
                      style: TextStyle(
                        color: Colors.white,
